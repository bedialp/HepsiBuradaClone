import { SearchIcon, MapPin, User2, ShoppingCart } from "lucide-react";
    ...
    <>
      ...
      <div className="flex">
        ...
        <div className="flex flex-col float-left w-auto items-end px-32 justify-end pt-1 ">
          ...
          <div className=" w-auto font-semibold text-sm">
            <a
              className="text-premium"
              href="https://www.hepsiburada.com/premium"
            >
              Premium&apos;u
            </a>{" "}
            keşfet
        ...
        <div className="flex flex-row gap-4 px-4 items-end ">
          ...
          {/* GİRİŞ YAP */}
          <button className="flex flex-row border-2 rounded-md border-gray-500">
            <div className="py-2 px-3">
              <User2 size={20} />
            </div>
            <div className="flex flex-col items-start ">
      ...
      <div className="grid grid-cols-7 w-screen pt-4">
        ...
        <div className="col-span-1 h- bg-purple-900"></div>
      </div>
      {/* MENU BAR */}
      <div>
